...
def get_player_move():
    # returns spot where move is made
...
def is_move_valid(board, row, col):
    # checks if move is withing parameters and spot is empty
...
def check_winner(board, player):
    # 1st line checks for winner in column
    # 2nd line checks for winner in row
    # 3rd and 4th line checks for winner in diagonal way
